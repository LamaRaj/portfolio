    ...
    <footer className="border-t border-white/10 bg-black/50 backdrop-blur-md pt-20 pb-10 mt-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-white/5 pb-16">
            ...
            <div className="flex gap-4 mt-8">
              {socialLinks.map((social, i) => (
                <a 
                  key={i} 
                  href={social.path}
                  className="p-3 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 hover:border-indigo-500/50 transition-all group"
                >
          ...
          <div>
            <h4 className="text-sm font-mono uppercase tracking-[0.2em] text-indigo-400 font-bold mb-8">Navigation</h4>
          ...
          <div>
            <h4 className="text-sm font-mono uppercase tracking-[0.2em] text-indigo-400 font-bold mb-8">Contact</h4>
            <div className="flex flex-col gap-4 text-slate-400 font-medium">
